...
public class ExamAttemptController(IExamAttemptServices examAttemptServices) : BaseApiController
{
    ...
    public async Task<IActionResult> GetAttemptsByStudent(String studentId, int examId)
    {
    ...
    [Authorize(Roles = "student")]
    public async Task<IActionResult> GetAttemptsCount(String studentId, int examId)
    {
    ...
    [Authorize(Roles = "student")]
    public async Task<IActionResult> GetLatestAttempt(String studentId, int examId)
    {
    ...
    [Authorize(Roles = "student")]
    public async Task<IActionResult> HasPassed(String studentId, int examId)
    {
    ...
    [Authorize(Roles = "student")]
    public async Task<IActionResult> StartAttempt(String studentId, StartExamAttemptDto dto)
    {
    ...
    [Authorize(Roles = "student")]
    public async Task<IActionResult> SubmitAttempt(String studentId, SubmitExamAttemptDto dto)
    {
