...
public interface IReviewServices
{
    ...
    Task<ServicesResponse<bool>> HasReviewedAsync(String studentId, int courseId);

    Task<ServicesResponse<Review>> AddReviewAsync(String studentId, ReviewCreateDto dto);
}